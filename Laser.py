...
class Laser(metodos):
    ...
    def caja_botones(self):
        ...
        self.button4=tk.Button(self.root,text="GENERATIVE AI ON",command=self.motoroff,background="gray",width=20,height=2,font=("arial", 20,"bold"))
        self.button4.place(x=220,y=800)
        
        self.button5=tk.Button(self.root,text="SYSTEM START",command=self.systemstart, background="gray",width=15,height=2,font=("arial", 20,"bold"))
        ...
        self.button7=tk.Button(self.root,text="AUTOMATIC POSITION",command=self.systemstart, background="dark gray",width=38,height=2,font=("arial", 26,"bold"))
        self.button7.place(x=30,y=900)
        
        
        '''CONTROL DEL MOTOR PASO A PASO POSICIONAMIENTO'''
        self.button8=tk.Button(self.root,text = u'\u25b2',command=self.systemstart, background="gray",width=3,height=1,font=("arial", 20,"bold"))
        self.button8.bind("<Button-1>")
        self.button8.place(x=900,y=780)
        
        self.button9=tk.Button(self.root,text = u'\u25bc',command=self.systemstart, background="gray",width=3,height=1,font=("arial", 20,"bold"))
        self.button9.bind("<Button-1>")
        self.button9.place(x=900,y=920)
        
        self.button10=tk.Button(self.root,text = u'\u25b6',command=self.systemstart, background="gray",width=3,height=1,font=("arial", 20,"bold"))
        self.button10.bind("<Button-1>")
        self.button10.place(x=930,y=850)
        
        self.button11=tk.Button(self.root,text = u'\u25c0',command=self.systemstart, background="gray",width=3,height=1,font=("arial", 20,"bold"))
